  ...
  useEffect(() => {
    ...
    clonedScene.traverse((obj) => {
      if ((obj as THREE.Mesh).isMesh) {
        ...
        // Czy ten obiekt zawiera "kolor" w nazwie?
        const isColorable = meshName.includes('kolor');
...
useGLTF.preload('/cdn-assets/assets/modele_ar/wiata_rowerowa/wiata_rowerowa_ar_v27.glb');
