...
const MODEL_URL = `${CLOUDFRONT_URL}/assets/modele_ar/wiata_rowerowa/wiata_rowerowa_ar_v07.glb`;
const AR_MODEL_URL = `${FULL_CLOUDFRONT_URL}/assets/modele_ar/wiata_rowerowa/wiata_rowerowa_ar_v07.glb`;
...
export default function PoznajKolorystyke({ kolory, elementy }: PoznajKolorystykeProps) {
  ...
  const handle3DClick = () => {
    try {
      ...
      if (isAndroid) {
        // Powrót do Scene Viewer (najstabilniejszy, używa materiałów z pliku)
